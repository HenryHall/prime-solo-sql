...
--6. Get the username and account balance of the 3 users with the lowest balances, sort lowest to highest balance. NOTE:  I have updated Anthony's account from 0.00 to 10.00 as per question 3.
...
--8. Add a new record.
INSERT INTO syntax_practice (username, city, transactions_completed, transactions_attempted, account_balance) VALUES ('henry', 'minneapolis', 0, 0, 10000000000.00);
